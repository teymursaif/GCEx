...
def initialize_params() :
    ...
    MAG_LIMIT_SAT, MAG_LIMIT_PSF, GC_SEL_PARAMS, ELL_LIMIT_PSF, GC_SIM_MODE, MERGE_CATS, MERGE_GC_CATS, MERGE_SIM_GC_CATS
    ...
    TARGETS.append(['1 ERO-NGC6254 ERO-NGC6254 254.29099 -04.09986 1 NISP-H MODEL_PSF ---']) #NISP-H,NISP-Y
    ...
    main_data_dir = working_directory+'ERO-data/ERO-GC/'#input_dir+'main_data/'
