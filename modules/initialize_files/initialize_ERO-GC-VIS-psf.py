...
def initialize_params() :
    ...
    MAG_LIMIT_SAT, MAG_LIMIT_PSF, GC_SEL_PARAMS, ELL_LIMIT_PSF, GC_SIM_MODE, MERGE_CATS, MERGE_SIM_GC_CATS, MERGE_GC_CATS
    ...
    WORKING_DIR = './'
    PRIMARY_FRAME_SIZE_ARCSEC = 3500 #arcsec
    FRAME_SIZE_ARCSEC = 3500 #cut-out size from the original frame for the general anlaysis (arcsec)
    ...
    TARGETS.append(['0 ERO-NGC6254 ERO-NGC6254 254.29099 -04.099865 1 VIS MODEL_PSF ---'])
    ...
    main_data_dir = working_directory+'ERO-data/ERO-GC/'
