...
def initialize_params() :
    ...
    MAG_LIMIT_SAT, MAG_LIMIT_PSF, GC_SEL_PARAMS, ELL_LIMIT_PSF, GC_SIM_MODE, MERGE_CATS, MERGE_SIM_GC_CATS, EXTRACT_DWARFS
    ...
    PRIMARY_FRAME_SIZE_ARCSEC = 100 #arcsec
    FRAME_SIZE_ARCSEC = 100 #cut-out size from the original frame for the general anlaysis (arcsec)
    ...
    for coord in COORDS:
        ...
        m = i
        ra, dec = coord
        target_str = str(m)+' ERO-PERSEUS ERO-PERSEUS-DWARF-'+str(m)+' '+str(ra)+' '+str(dec)+' 70 VIS,NISP-Y,NISP-J,NISP-H MAKE_CAT ---'
